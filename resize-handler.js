  ...
  demoFrame.addEventListener("load", function () {
    ...
    setTimeout(() => {
      if (demoFrame.contentWindow) {
        demoFrame.contentWindow.dispatchEvent(new Event("resize"));
      }
    }, 100);
  });
