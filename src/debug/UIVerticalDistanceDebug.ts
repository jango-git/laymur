...
import type { UIVerticalDistanceConstraint } from "../core";
...
export class UIVerticalDistanceDebug implements UIConstraintDebug {
  ...
  constructor(public readonly constraint: UIVerticalDistanceConstraint) {
  ...
  private readonly onRendering = (renderer: WebGLRenderer): void => {
    ...
    const nextText: string = "VD: " + this.constraint.distance.toFixed(0);
    ...
    this.textSprite.position.set(midX + 20, (anchorAY + anchorBY) / 2, 0);
  };
